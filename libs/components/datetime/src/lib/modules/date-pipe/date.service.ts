...
export class SkyDateService implements OnDestroy {
  ...
  #ALIASES: Record<string, string> = {
    ...
    // This format was modified from 'MMMM d, y, h:mm:ss a z' due to the limitations of the Intl API.
    ...
    // This format was modified from 'h:mm:ss a z' due to the limitations of the Intl API.
